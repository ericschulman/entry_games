...
class HomeDepotScraper(GenericScraper):
    ...
    def click_state_links(self):
        ...
        state_element = driver.find_element(By.XPATH, '(//*[@class="stateList__item"])[1]') 
        #to fully understand the previous line, you will have to under stand what the xpath query is doing
        # i.e. the xpath query is the second argument "//*[@class="stateList__item"])[1]'"
        #what does [1] do?
        #what does * do?
        #what does @class do?
